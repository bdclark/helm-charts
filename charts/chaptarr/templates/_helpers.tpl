...
Common labels
*/}}
{{- define "chaptarr.labels" -}}
helm.sh/chart: {{ include "chaptarr.chart" . }}
{{ include "chaptarr.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "chaptarr.selectorLabels" -}}
app.kubernetes.io/name: {{ include "chaptarr.name" . }}
...
*/}}
{{- define "chaptarr.validateConfig" -}}
